...
//  test-app2
//
//  Created by Yonatan Mamo on 05.06.22.
//
...
public struct Message {
    ...
    public static func generateMessage(kind: Message.Kind, count: UInt) -> [ChatMessageItem] {
        (1...count).map { _ in generateMessage(kind: kind) }
    }
    
    public static func generateMessage(kind: Message.Kind) -> ChatMessageItem {
...
//                        imageURL: URL(string:"https://picsum.photos/400/300"),
    ...
    public static var randomMessageKind: Message.Kind {
        let allCases: [Message.Kind] = [
            .Image,
            .Text, .Text, .Text,
            .Contact,
            .Text, .Text, .Text,
